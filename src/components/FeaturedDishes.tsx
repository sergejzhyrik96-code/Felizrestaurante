...
const dishes = [
  { name: "Paella Valenciana", price: "€24.90", image: dishPaella, tag: "Signature" },
  { name: "Secreto Ibérico", price: "€26.50", image: dishSecreto, tag: "Chef's Pick" },
  { name: "Jamón Ibérico", price: "€22.00", image: dishJamon, tag: "Premium" },
  { name: "Crema Catalana", price: "€8.50", image: dishCrema, tag: "Classic" },
];
        ...
        >
          <div>
            ...
            <h2 className="mt-3 font-display text-4xl font-light text-foreground md:text-6xl">
              Signature <span className="italic font-semibold">Dishes</span>
            </h2>
          </div>
          <Link
            to="/menu"
